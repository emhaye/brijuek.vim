" Brijuek - A 24-bit Material color scheme for Vim
...
set background=dark
let g:colors_name = 'brijuek'

let g:enable_brijuek_italics = get(g:, 'brijuek_italics', 1)
let g:brijuek_black = get(g:, 'brijuek_black', 1)
...
function! s:HL(group, fg, bg, attr)
    let l:attr = a:attr
    if !g:enable_brijuek_italics && l:attr ==# 'italic'
        let l:attr = 'none'
    endif
...
" Vim Editor
call s:HL('ALEErrorSign',                   s:red,      s:gray3,    '')
call s:HL('ALEStyleErrorSign',              s:red,      s:gray3,    '')
call s:HL('ALEWarningSign',                 s:yellow,   s:gray3,    '')
call s:HL('ALEStyleWarningSign',            s:yellow,   s:gray3,    '')
call s:HL('ALEInfoSign',                    s:cyan,     s:gray3,    '')
...
call s:HL('LineNr',                         s:gray4,    s:black,    '')
...
call s:HL('Pmenu',                          s:gray5,    s:black,    '')
...
call s:HL('rubyCurlyBlockDelimiter',        s:gray5,    '',     'Bold')
...
call s:HL('rubyIdentifier',                 s:cyan,     '',     'Bold')
